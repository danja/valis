...
I don't know what we have already, but a test fixture that can examine the actual signal behaviour of an individual element would be useful. Then each element could have its own test for sanity-checking levels etc.

A signal generator, an oscilloscope and a freq analysis meter elements could be useful during circuit development.
