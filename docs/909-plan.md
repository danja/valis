A  model of the TR-909 drum synth which faithfully follows the functional circuit blocks of the original.

The instruments will respond to note messages corresponding to General MIDI standard on channel 10.
...
This will be added as a new case study in the docs.
